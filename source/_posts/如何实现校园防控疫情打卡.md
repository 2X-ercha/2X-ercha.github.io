...
abbrlink: 7431
data: 2021-01-24 23:38:00
updatad: 2021-01-29 9:58:00
---
{% note warning simple %}
...
data = {
  ...
  "RealCity":"长沙市",
  "RealCounty":"岳麓区",
  "RealAddress":"麓山南路湖南大学德智园学生公寓x-xxx",
  # 以下0表示否，1表示是
  "IsNormalTemperature":"1",  # 是否体温正常（现版本必填）
  "IsInCampus":"0",    # 是否在校（现版本必填）
  # 以下省略“本人及亲属”
  "IsUnusual":"0",    # 是否有不良反应（现版本必填）
  "UnusualInfo":"",   # 不良反应情况
  "IsTouch":"0",      # 是否接触（现版本必填）
  "IsInsulated":"0",  # 是否隔离
  "IsSuspected":"0",  # 是否疑似
  "IsDiagnosis":"0",  # 是否确诊
  "dailyinfo":{
    "IsVia":"0",      # 是否从中高风险地区返回（现版本必填）
    "DateTrip":""
  }
