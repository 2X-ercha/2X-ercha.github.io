...
> 本文转载自店长的[Akilarの糖果屋-基于Butterfly的外挂标签引入](https://akilar.top/posts/615e2dec/)，已获得作者许可。  
> 本教程只用于猹自己写文的时候做参考（这么多样式猹记不住）  
> 另外说明，本转载并不完整，一部分需要其他魔改引入支持的内容已经删除，如有需要请查看店长原帖  
> 以下为转载内容
